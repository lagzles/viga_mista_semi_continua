...
def calculo_C(Es, E, Asl, fck, fys, ha, d, bf, tw, tf, hdeck, vao, vaoad, largInfluencia):
    ...
    areaPerfil = round(prop.area(d, tw, bf, tf, bf, tf), 2)
    ia = round(prop.i_x(d, tw, bf, tf, bf, tf), 2)
    Es = Es / 10000
    E = E / 10000
    vao *= 100
    vaoad *= 100
    ...
    # print('vaoad', vaoad )
    #
    # print('larguraEfetiva', larguraEfetiva )
    ...
    return (C1, tetau, ylnp)


def inercia_equivalente_curta(vao, largInfluencia, interna, hdeck, d, ia, aa, fck, fy, E):
    # print('inercia curta')
    Qrd = 70.7
...
def inercia_equivalente_longa(vao, vaoad, largInfluencia, interna, hdeck, d, Asl, ia,aa, fck, fy, E):
    # print('inercia longa')
